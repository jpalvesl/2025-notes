...
---
# Importação de CVs
## Erros causados por alteração de CV
- V_CONTAS_PARTE_B_DISPONIVEIS_CONFIGURAR
- V_VALORES_CALCULADOS
- V_INTERFACE_VALORES_CALCULADOS

- IDENTIFICACAO_CONTA_PARTEB_BACKUP

---
# Lembretes
- [ ] Lembrar de importar o complemento que versionamos anteriormente e remover alteração de suporte.